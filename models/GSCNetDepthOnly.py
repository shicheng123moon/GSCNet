...
class GeneralWiseSeparableConv(nn.Module):
    ...
    def forward(self, x):
        ...
        split2 = self.depthwiseConv(split2)
        split3 = self.depthwiseConv(split3)
...
class GSCNetDepthOnly(nn.Module):
    def __init__(self, input_height=224, input_width=224, in_channels=3, n_classes=1000, width_mult=1., dropout_ratio=0.2,
        ...
        super(GSCNetDepthOnly, self).__init__()
...
if __name__=="__main__":
    model = GSCNetDepthOnly(input_height=320, input_width=320, in_channels=3, n_classes=1000, width_mult=1., dropout_ratio=0.2,
                 use_batch_norm=True, onnx_compatible=False)
